...
def plot(energy1, data1, octa1, tetra1, energy, fit, residual, name, namefile):
    namefile = namefile.rstrip('_norm_shifted.txt')
    fig = plt.figure()
    ax = fig.add_subplot(1, 1, 1)

    
    plt.plot(energy1, data1, markersize=0.1, label = name)
    ...
    plt.yticks(np.arange(0, 0.002, step=0.0004), np.arange(5))
    
    plt.axis([9638.5, 9661.5, -0.0002, 0.002])
